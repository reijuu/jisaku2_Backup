...
import reijuu.jisakuMod2.datagen.server.JisakuWorldGenProvider;
...
public class JisakuDataGenerators {
    ...
    public static void gatherData(GatherDataEvent event) {
        ...
        // WorldGen
        generator.addProvider(event.includeServer(), new JisakuWorldGenProvider(packOutput, lookupProvider));
    }
}
